        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="mb-8">
                ...
                <h2 class="text-lg py-2">
                    Rua Francisco Medeiros, N°243, Centro<br />Bela Vista de
                    Goiás/GO - CEP: 75240-000
                </h2>
                <div
                    class="mt-6 p-4 h-80 rounded-3xl border-4 border-orange-300 text-xl text-justify relative overflow-hidden"
                >
                    <iframe
            ...
            <div class="flex flex-col justify-end text-sm font-bold px-4 py-6">
                <UForm @submit="onSubmit">
                    <UFormGroup class="w-full mb-4">
                        <UInput placeholder="Nome" required min="2" />
                    </UFormGroup>
                    <UFormGroup class="w-full mb-4">
                        <UInput placeholder="E-mail" required type="email" />
                    </UFormGroup>
                    <UTextarea
                        color="white"
                        variant="outline"
                    ...
                    />
                    <button
                        class="my-2 py-2 rounded-lg w-full border-2 border-gray-800 bg-black text-xl text-gray-100"
                    >
                        Enviar
                    </button>
                </UForm>
